    ...
    return gulp.src(getFilesToProcess(paths.input.stylesFiles))
        ...
        .pipe(sass({
            ...
            functions: assetFunctions({
                images_path: paths.output.images,
                fonts_path: paths.output.fonts,
                http_images_path: '../../'+paths.output.images,
                http_fonts_path: '../../'+paths.output.fonts
            })
...
gulp.task('vendor-move', function(cb) {
    var filesToProcess = getFilesToProcess(paths.input.vendorFiles, false);
    return gulp.src(filesToProcess)
...
gulp.task('watch', function() {
    ...
    gulp.watch(getFilesToProcess(paths.input.templateFiles), ['templates']);
    gulp.watch(getFilesToProcess(paths.input.vendorFiles), ['vendor-move']);
});
...
gulp.task('default', ['clean'], function() {
    return gulp.start(['sprite', 'img', 'fonts-move', 'css', 'css-move', 'js-process', 'js-move', 'templates', 'vendor-move', 'watch']);
});
...
gulp.task('upload', ['clean'], function() {
    ...
    return gulp.start(['img', 'css', 'css-move', 'js-process', 'js-move', 'templates', 'vendor-move', 'watch']);
});

gulp.task('build', ['clean'], function() {
    environment = 'production';
    return gulp.start(['sprite', 'img', 'fonts-move', 'css', 'css-move', 'js-process', 'js-move', 'vendor-move', 'templates']);
});
